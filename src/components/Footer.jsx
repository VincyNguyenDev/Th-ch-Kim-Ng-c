    ...
    <div className='bg-darkBackground text-white'>
       <div className='flex flex-col md:flex-row justify-between p-8 md:mx-32 px-5'>
        <div className='w-full md:w-1/4'>
            ...
            <p className='text-sm'>With TripPixie you can experience new travel and the best tourist destinations that we have to offer</p>
        </div>
        <div>
       ...
       <div>
        <p className='text-center py-4'>
            ...
            <span className='text-brightColor'> Thạch Kim Ngọc </span> | All rights reversed
        </p>
       </div>
    </div>
  )
